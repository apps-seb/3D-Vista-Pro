...
const server = app.listen(3000, async () => {
    ...
    // wait for display-title to be updated
    ...
    // Wait for the change to propagate and be updated via supabase realtime
    await indexPage.waitForTimeout(3000); // 3 seconds
